...
namespace SudokuSolverTests
{
    ...
    public class SudokuStrategyResultTests : SudokuTests
    {
        ...
        {
            Action act = () => SudokuStrategyResult.FromValue(null, "test");
            act.ShouldThrow<ArgumentNullException>();

            act = () => SudokuStrategyResult.FromValue(new SudokuSquare(1, 1, new int[] { 1, 2 }), "test");
            ...
            var result = SudokuStrategyResult.FromValue(square, "test");
        ...
        {
            Action act = () => SudokuStrategyResult.FromImpossibleCandidates(null, null, "test");
            act.ShouldThrow<ArgumentNullException>().And.ParamName.Should().Be("squares");

            act = () => SudokuStrategyResult.FromImpossibleCandidates(Enumerable.Empty<SudokuSquare>(), null, "test");
            ...
            act = () => SudokuStrategyResult.FromImpossibleCandidates(squares, new int[] { }, "test");
            act.ShouldThrow<ArgumentOutOfRangeException>().And.ParamName.Should().Be("candidates");

            int[] candidates = new int[] { 2 };
            var result = SudokuStrategyResult.FromImpossibleCandidates(squares, candidates, "test");
